/***********************************************************************
 * Module:  MaskWord.java
 * Author:  zhb_1204
 * Purpose: Defines the Class MaskWord
 ***********************************************************************/

package com.neusoft.arltr.common.entity.mask;
...
public class MaskWord {
   /** id */
   @Id 
   @GeneratedValue(strategy=GenerationType.SEQUENCE,generator="maskseq")
   @SequenceGenerator(name="maskseq",sequenceName="MASK_SEQ",allocationSize=1)
   private Integer id;
   /** 词条 */
